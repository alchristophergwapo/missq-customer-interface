...
/***/ "z/sj":
/*!***********************************************!*\
  !*** ./src/app/api/services/photo.service.ts ***!
  \***********************************************/
...
let PhotoService = class PhotoService {
    ...
    savePicture(cameraPhoto) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const savedFile = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Filesystem"].writeFile({
                path: fileName,
                data: base64Data,
    ...
    loadSaved() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const photoList = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Storage"].get({ key: this.PHOTO_STORAGE });
            ...
            if (!this.platform.is('hybrid')) {
                ...
                for (let photo of this.photos) {
                    ...
                    const readFile = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Filesystem"].readFile({
                        path: photo.filepath,
                        directory: _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["FilesystemDirectory"].Data
                    });
...
/* harmony import */ var _api_services_photo_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../api/services/photo.service */ "z/sj");
...
HomePage.ctorParameters = () => [
    { type: _api_services_photo_service__WEBPACK_IMPORTED_MODULE_4__["PhotoService"] }
];
